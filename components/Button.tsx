...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "border-transparent text-white bg-orange-600 hover:bg-orange-700 focus:ring-orange-500 shadow-lg",
    secondary: "border-transparent text-orange-800 bg-orange-100 hover:bg-orange-200 focus:ring-orange-500",
