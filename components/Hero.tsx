  ...
  return (
    <div className="relative bg-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Changed from blue mix-blend to orange/amber for warmth */}
        <div className="absolute inset-0 bg-orange-900/80 mix-blend-multiply" />
      </div>

      <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl mb-6">
          成為改變的力量
          <span className="block text-orange-400 mt-2 text-2xl sm:text-4xl">南投縣技職教育協會講師招募</span>
        </h1>
